...
pub const SYS_DRIVER_REGISTER: usize = 500;
pub const SYS_DRIVER_REQUEST_IRQ: usize = 501;
pub const SYS_DRIVER_MAP_MMIO: usize = 502;
pub const SYS_DRIVER_DMA_ALLOC: usize = 503;
...
pub fn sys_driver_register(reg_ptr: usize, reg_size: usize) -> SysResult {
    ...
    let current_epid = EndpointId(crate::kernel_core::scheduler::current_pid());
