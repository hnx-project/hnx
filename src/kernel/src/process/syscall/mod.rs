...
// 使用 hnx-abi 中定义的系统调用号和类型
use crate::abi::{
    SYS_WRITE, SYS_EXIT, SYS_OPEN, SYS_READ, SYS_CLOSE, SYS_YIELD,
    SYS_IPC_WAIT, SYS_IPC_WAKE, SYS_EP_CREATE, SYS_EP_SEND, SYS_EP_RECV,
    SYS_DLOPEN, SYS_DLCLOSE, SYS_DLSYM, SYS_CREAT, SYS_UNLINK, SYS_MKDIR, SYS_RMDIR,
...
use crate::abi::{O_RDONLY, O_WRONLY, O_RDWR, O_CREAT, O_TRUNC, O_APPEND};

// File descriptor entry (using hnx-abi definition)
use crate::abi::FdEntry;
