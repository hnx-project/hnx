...
pub fn init() {
    ...
    crate::info!("fs ok");
    let _ = crate::core::ipc::register(crate::core::ipc::SERVICE_VFS, ipc_handler);
}
...
pub fn ipc_handler(msg: &crate::core::ipc::Msg) -> crate::core::ipc::Resp {
    match msg.op {
        4 => {
            // Read operation
            ...
            if let Some(metadata) = fs.stat(bytes, path) {
                if !fs.check_permission(&metadata, "read") {
                    return crate::core::ipc::Resp { code: -3, len: 0 }; // Permission denied
                }
            }
            ...
            if let Some((start, size)) = crate::fs::vfs::find_file(bytes, path) {
                ...
                if n == 0 {
                    return crate::core::ipc::Resp { code: 0, len: 0 };
                }
                unsafe {
                    core::ptr::copy_nonoverlapping((start as *const u8).add(off), msg.p2, n);
                }
                crate::core::ipc::Resp { code: 0, len: n }
            } else {
                crate::core::ipc::Resp { code: -2, len: 0 }
            }
        }
        5 => {
        ...
        6 => {
            ...
            if entries.is_empty() {
                crate::core::ipc::Resp { code: -1, len: 0 }
            } else {
                ...
                crate::core::ipc::Resp { code: 0, len: offset }
            }
        }
        7 => {
            // Get file size
            ...
            if let Some((_start, size)) = crate::fs::vfs::find_file(bytes, s) {
                crate::core::ipc::Resp { code: 0, len: size }
            } else {
                crate::core::ipc::Resp { code: -1, len: 0 }
            }
        }
        8 => {
            ...
            crate::core::ipc::Resp { code: -1, len: 0 }  // Read-only filesystem
        }
        9 => {
        ...
        12 => {
            ...
            match ramfs.mkdir(s, mode) {
                Ok(()) => {
                    ...
                    crate::core::ipc::Resp { code: 0, len: 0 }
                }
                Err(e) => {
        ...
        _ => crate::core::ipc::Resp { code: -1, len: 0 },
    }
}