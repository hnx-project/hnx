...
impl UserTls for x86_64 {
    ...
    fn get_thread_pointer() -> usize {
        unimplemented!("x86_64 thread pointer not implemented")
    }
}

impl UserContext for x86_64 {
    type Context = [usize; 32];
    
    fn make_context(_stack: *mut u8, _func: extern fn(usize), _arg: usize) -> Self::Context {
        unimplemented!("x86_64 context not implemented")
    }
