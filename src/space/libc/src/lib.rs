...
const SYS_WRITE: usize = 0x1001;
const SYS_EXIT: usize = 0x1002;
const SYS_READ: usize = 0x1003;
const SYS_OPEN: usize = 0x1004;
const SYS_CLOSE: usize = 0x1005;
const SYS_SOCKET: usize = 0x1006;
const SYS_BIND: usize = 0x1007;
const SYS_CONNECT: usize = 0x1008;
const SYS_SEND: usize = 0x1009;
const SYS_RECV: usize = 0x100A;
const SYS_LISTEN: usize = 0x100B;
const SYS_ACCEPT: usize = 0x100C;
const SYS_IOCTL: usize = 0x100D;
const SYS_CHANNEL_CREATE: usize = 0x100E;
const SYS_CHANNEL_WRITE: usize = 0x100F;
const SYS_CHANNEL_READ: usize = 0x1010;
...
pub mod syscalls {
    ...
    pub unsafe fn sys_socket(domain: i32, type_: i32, protocol: i32) -> i32 {
        syscall3(SYS_SOCKET, domain as usize, type_ as usize, protocol as usize) as i32
    }
    ...
    pub unsafe fn sys_bind(sockfd: i32, addr: *const u8, addrlen: usize) -> i32 {
        syscall3(SYS_BIND, sockfd as usize, addr as usize, addrlen) as i32
    }
    ...
    pub unsafe fn sys_connect(sockfd: i32, addr: *const u8, addrlen: usize) -> i32 {
        syscall3(SYS_CONNECT, sockfd as usize, addr as usize, addrlen) as i32
    }
    ...
    pub unsafe fn sys_send(sockfd: i32, buf: *const u8, len: usize, flags: i32) -> isize {
        syscall3(SYS_SEND, sockfd as usize, buf as usize, len) as isize
    }
    ...
    pub unsafe fn sys_recv(sockfd: i32, buf: *mut u8, len: usize, flags: i32) -> isize {
        syscall3(SYS_RECV, sockfd as usize, buf as usize, len) as isize
    }
    ...
    pub unsafe fn sys_listen(sockfd: i32, backlog: i32) -> i32 {
        syscall2(SYS_LISTEN, sockfd as usize, backlog as usize) as i32
    }
    ...
    pub unsafe fn sys_accept(sockfd: i32, addr: *mut u8, addrlen: *mut usize) -> i32 {
        syscall3(SYS_ACCEPT, sockfd as usize, addr as usize, addrlen as usize) as i32
    }
    ...
    pub unsafe fn sys_channel_create(options: usize, out0: *mut u32, out1: *mut u32) -> i32 {
        syscall3(SYS_CHANNEL_CREATE, options, out0 as usize, out1 as usize) as i32
    }
    ...
    pub unsafe fn sys_channel_write(handle: usize, options: usize, bytes: *const u8, 
        ...
        syscall3(SYS_CHANNEL_WRITE, handle, bytes as usize, num_bytes) as i32
    }
    ...
    pub unsafe fn sys_channel_read(handle: usize, options: usize, bytes: *mut u8, handles: usize,
        ...
        syscall3(SYS_CHANNEL_READ, handle, bytes as usize, num_bytes) as i32
    }
}
