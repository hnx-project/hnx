...
impl Channel {
    ...
    /// 发送消息到对端通道
    pub fn write(&self, data: &[u8], handles: Vec<crate::object::Handle>) -> Result<(), ObjectError> {
        // 检查消息大小
    ...
    /// 从通道读取消息
    pub fn read(&self, buffer: &mut [u8], max_handles: usize) -> Result<(usize, Vec<crate::object::Handle>), ObjectError> {
